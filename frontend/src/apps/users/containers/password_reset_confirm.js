...
export class PasswordResetConfirm extends Component {
  ...
  renderForm() {
    return (
      <div
        className={cx('password-reset-confirm-form', {
          hidden: this.state.submitPending || this.state.submitSuccess,
        })}
      >
        <Form
          ...
          {formApi => {
            return (
              <form onSubmit={formApi.submitForm}>
                ...
                {this.state.submitErrors.uid ||
                this.state.submitErrors.token ? (
                  <div className={'error'}>
                    {gettext(
...
const PasswordResetConfirmWrapper = () => (
  <MuiThemeProvider>
